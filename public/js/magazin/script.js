...
">
                                    ...
                                    <div id="uploader_file">
                                        <div class="uploadDoc">
                                          ...
                                          <div class=""><a class="btn-check"><i class="fa fa-times"></i></a></div><!-- col-1 -->
                                        </div>
                                    </div>
...
function AddMyShop() {
    ...
    var button_fail = $('.fileUpload')
    var uploader_fail = $('<input type="file" class="upload up" id="up">\n')
    var fileTypes = ['pdf', 'docx', 'rtf', 'jpg', 'jpeg', 'png', 'txt'];  
    button_fail.on('click', function () {
        uploader_fail.click()
    })

    uploader_fail.on('change', function () {


        readURL(uploader_fail[0])
    })
    function readURL(input) {
        if (input.files && input.files[0]) {
            ...
            if (isSuccess) { //yes
                ...
                reader.onload = function (e) {
                    if (extension == 'pdf'){
                        $('.fileUpload').find(".icon").attr('src','https://image.flaticon.com/icons/svg/179/179483.svg');
                    }
                    else if (extension == 'docx'){
                        $('.fileUpload').find(".icon").attr('src','https://image.flaticon.com/icons/svg/281/281760.svg');
                    }
                    else if (extension == 'rtf'){
                        $('.fileUpload').find(".icon").attr('src','https://image.flaticon.com/icons/svg/136/136539.svg');
                    }
                    else if (extension == 'png'){
                        $('.fileUpload').find(".icon").attr('src','https://image.flaticon.com/icons/svg/136/136523.svg');
                    }
                    else if (extension == 'jpg' || extension == 'jpeg'){
                        $('.fileUpload').find(".icon").attr('src','https://image.flaticon.com/icons/svg/136/136524.svg');
                    }
                    else if (extension == 'txt'){
                        $('.fileUpload').find(".icon").attr('src','https://image.flaticon.com/icons/svg/136/136538.svg');
                    }
                    else {
                        //console.log('here=>'+$(input).closest('.uploadDoc').length);
                        $('.uploadDoc').find(".docErr").slideUp('slow');
                    }
                }
        ...
        $(document).on('click',".btn-new",function(){
            alert()
            $("#uploader_file").append('<div class="uploadDoc">\n' +
                '                                          <div class="">\n' +
                '\n' +
                '                                            <div class="fileUpload">\n' +
                '                                              <img src="https://image.flaticon.com/icons/svg/136/136549.svg" class="icon">\n' +
